...
import com.app.spent.ui.analytics.components.NetSavingsChart
import com.app.spent.ui.analytics.components.SavingsSummaryCard
import com.app.spent.ui.analytics.components.TotalBalanceChart
...
fun AnalyticsScreen(
  ...
  LazyColumn(
    ...
    // 1. Income vs Expense Summary Card
    item {
      SavingsSummaryCard(
    ...
    // 2. Total Balance Over Time Chart (Cumulative total money)
    item {
      TotalBalanceChart(
    ...
    // 3. Income vs Expenses Chart (Period net comparisons)
    item {
      NetSavingsChart(
        transactions = state.recentTransactions,
        currencySymbol = state.currencySymbol
