...
class StringResourcesLocalizationTest {
    ...
    companion object {
        private val EXPECTED_LOCALES = listOf("values", "values-es", "values-pt", "values-fr", "values-de", "values-it")
    ...
    fun testLanguageSelectionKeysConfigured() {
        ...
        val languageKeys = listOf("language_title", "language_desc", "language_system", "language_en", "language_es", "language_pt", "language_fr", "language_de", "language_it")
